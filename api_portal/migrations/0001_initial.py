    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(fields=["date"], name="api_portal__date_24e574_idx")
                ],
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["endpoint"], name="api_portal__endpoin_47cb57_idx"
                    ),
                    models.Index(
                        fields=["user"], name="api_portal__user_id_958031_idx"
                    ),
                    models.Index(
                        fields=["timestamp"], name="api_portal__timesta_bcadb8_idx"
                    ),
                ],
            },
        ),
