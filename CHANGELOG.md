...
### ✨ New Features
- Added a **Copy Full API URL** action in the docs request section.
  - Shows the full absolute URL for the selected endpoint
  - Includes current path parameter substitutions and query parameters
  - Lets users copy the exact request URL in one click

### 🔧 Improvements
- Updated default version values in package settings and sample project configuration to `1.0.9`
- Updated installation and quick start documentation examples to use `1.0.9`
...
### 🐛 Bug Fixes
- fix: Correct log entry sorting field from 'created_at' to 'timestamp'
