...
SECRET_KEY = "django-insecure-(kt+0vfn%!4_^uc@x5omcoe)5t94ue@xb0@5@9r8!z@@vuk%3j"
...
MODERN_DRF_SWAGGER = {
    ...
    "MAX_HISTORY_PER_USER": 100,  # Auto-cleanup old logs
    "ALLOW_ANONYMOUS": False,  # Require authentication
    # Schema Settings (controls drf-spectacular)
    "SCHEMA_PATH_PREFIX": r"/api/v1/",  # Only show endpoints starting with /api/v1/
    # UI Settings
